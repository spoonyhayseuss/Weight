...
public class e_weight_b_d_edit195 extends ActivityInstrumentationTestCase2 {
  	private Solo solo;
    ...
    public e_weight_b_d_edit195() throws ClassNotFoundException {
	...
	public void testRun() {
		...
		solo.clickOnText(java.util.regex.Pattern.quote("10 lbs to go"));
