...
public class e_weight_d_c_kgToLbs extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public e_weight_d_c_kgToLbs() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("2.2 kg to go"));
